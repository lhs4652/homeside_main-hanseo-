      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            <strong>
              복잡한 주거지 탐색부터 불안한 계약까지, 혼자서 해결하려니
              막막하셨죠?
            </strong>
            <br />
            ...
            <br />
            <strong>
              부동산 내편은 고객이 겪는 모든 스트레스를 덜어주는 지금까지
              없었던, 전문가 동행 부동산 솔루션입니다
            </strong>
          </p>
          <p className='text-sm text-gray-400 mt-4'>
            (결혼 준비에 웨딩플래너가, 중고차 구매에 동행 전문가가
            있다면,&#39;이젠 집 구하기에도 믿을 수 있는 내편이 필요합니다)
          </p>
        </div>
          ...
          <div className='grid grid-cols-1 gap-10 max-w-2xl mx-auto'>
            ...
            <div className='bg-white rounded-3xl shadow-lg p-8 flex gap-6 items-start border border-gray-100 hover:shadow-2xl transition-all duration-300 group relative'>
              ...
              <div>
                ...
                <div className='text-gray-600 text-base leading-relaxed md:leading-loose'>
                  하자, 일조량, 구조, 층간소음까지
                  <br />
                  홈플래너가 현장을 직접 방문해 체크리스트로 꼼꼼히 확인하고
                  집보기 리포트 제공
                </div>
              </div>
            </div>
            ...
            <div className='bg-white rounded-3xl shadow-lg p-8 flex gap-6 items-start border border-gray-100 hover:shadow-2xl transition-all duration-300 group relative'>
              ...
              <div>
                ...
                <div className='text-gray-600 text-base leading-relaxed md:leading-loose'>
                  계약서 문구 하나가 수천만원의 손실을 부를 수 있습니다.
                  <br />
                  AI가 등기부등본, 건축물대장, 특약사항을 분석해 위험요소를
                  한눈에!
                  <br />
            ...
            <div className='bg-white rounded-3xl shadow-lg p-8 flex gap-6 items-start border border-gray-100 hover:shadow-2xl transition-all duration-300 group relative'>
              ...
              <div>
                ...
                <div className='text-gray-600 text-base leading-relaxed md:leading-loose'>
                  웨딩플래너처럼 전담 매니저가 인테리어, 이사, 입주까지 토탈
                  관리
                  <br />
        ...
        <div className='text-center my-12'>
          ...
          <p className='text-lg text-gray-700'>
            이제는 혼자 고생하지 마세요.
            <br />
            내가 찾는 집, 내가 안심할 계약,내 옆엔 언제나 &#39;부동산
            내편&#39;이 함께합니다.
          </p>
        </div>
